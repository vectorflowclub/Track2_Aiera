Here's your complete README.md — just fill in your team name and final IoU score:
...
|---|---|---|
| Mean IoU | 0.1968 | [YOUR FINAL IoU] |
| Pixel Accuracy | 0.69 | [YOUR FINAL ACC] |
| Val IoU | 0.2707 | [YOUR FINAL VAL] |
...
Just fill in:
1. `[YOUR TEAM NAME]`
2. `[YOUR FINAL IoU]` after training finishes
3. `[YOUR FINAL ACC]`
4. `[YOUR FINAL VAL]`
5. Team member names

Save it as `README.md` in your Scripts folder. That's submission ready.